			...
			<section class="contain">
				<form class="addpad" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
					<div class="inputgroup">
						...
						<input type="text" id="name" name="name" placeholder="姓氏與名字" required>
					</div>
					<div class="inputgroup">
					...
					<div class="inputgroup">
						...
						<input type="tel" id="phone" name="phone" placeholder="0900123456" required>
					</div>
					<div class="inputgroup">
						<label>性別</label>
						<label for="male">男</label><input type="radio" id="male" name="gender" value="male" required>
						<label for="female">女</label><input type="radio" id="female" name="gender" value="female" required>
					</div>
					<div class="inputgroup">
					...
					<div class="inputgroup">
						...
						<input type="text" id="address" name="address" placeholder="你的地址" required>
					</div>
